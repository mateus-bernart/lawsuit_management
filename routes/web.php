...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/financial-records/{financial_record}/edit', [App\Http\Controllers\FinancialRecordController::class, 'edit'])->name('financial-record.edit');
    Route::post('/financial-records/{financial_record}', [App\Http\Controllers\FinancialRecordController::class, 'update'])->name('financial-record.update');
    Route::delete('/financial-records/{financial_record}', [App\Http\Controllers\FinancialRecordController::class, 'destroy'])->name('financial-record.destroy');
    Route::put('/financial-records/{financial_record}/toggle-active', [App\Http\Controllers\FinancialRecordController::class, 'toggleActive'])->name('financial-record.toggleActive');
    Route::put('/financial-records/{financial_record}/toggle-status', [App\Http\Controllers\FinancialRecordController::class, 'toggleStatus'])->name('financial-record.toggleStatus');
});
